...
func (app *MeichainApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *MeichainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
